  ...
  return (
    <div className='main-page-container'>
        ...
        <div className='main-page-signup'>
            ...
            <button className="signup-button" onClick={() => {setOpenSignupModal(true);}}>Sign Up Here!</button>
            <br />
            Already a member? 
            <button className="login-button" onClick={() => {setOpenLoginModal(true);}}>Log in here! 
            </button>
