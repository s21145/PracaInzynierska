...
namespace pracaInzynierska_backend.Migrations
{
    ...
    [Migration("20220622195600_poprawiona literowka")]
    partial class poprawionaliterowka
    {
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CommentId = 1,
                            Content = "Komentarz 1",
                            Date = new DateTime(2022, 6, 22, 21, 55, 59, 918, DateTimeKind.Local).AddTicks(8246),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 2,
                            Content = "Komentarz 2",
                            Date = new DateTime(2022, 6, 22, 21, 55, 59, 918, DateTimeKind.Local).AddTicks(8256),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 3,
                            Content = "Komentarz 3",
                            Date = new DateTime(2022, 6, 22, 21, 55, 59, 918, DateTimeKind.Local).AddTicks(8258),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 4,
                            Content = "Komentarz 4",
                            Date = new DateTime(2022, 6, 22, 21, 55, 59, 918, DateTimeKind.Local).AddTicks(8260),
                            IdPost = 1,
                            IdUser = 1
                        });
                });
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            BirthDate = new DateTime(2002, 6, 22, 21, 55, 59, 918, DateTimeKind.Local).AddTicks(4817),
                        ...
                        {
                            UserId = 2,
                            BirthDate = new DateTime(1997, 6, 22, 21, 55, 59, 918, DateTimeKind.Local).AddTicks(4843),
                            Description = "Lubie CS GO",
                        ...
                        {
                            UserId = 3,
                            BirthDate = new DateTime(1992, 6, 22, 21, 55, 59, 918, DateTimeKind.Local).AddTicks(4845),
                            Description = "Lubie CS GO",
                            Email = "Zielony@o2.pl",
                            Login = "Garo",
                            Password = "bedzieHash"
