...
namespace pracaInzynierska_backend.Migrations
{
    ...
    [Migration("20240723131019_addDateToPost")]
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CommentId = 1,
                            Content = "Komentarz 1",
                            Date = new DateTime(2024, 7, 23, 15, 10, 18, 805, DateTimeKind.Local).AddTicks(8794),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 2,
                            Content = "Komentarz 2",
                            Date = new DateTime(2024, 7, 23, 15, 10, 18, 805, DateTimeKind.Local).AddTicks(8798),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 3,
                            Content = "Komentarz 3",
                            Date = new DateTime(2024, 7, 23, 15, 10, 18, 805, DateTimeKind.Local).AddTicks(8800),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 4,
                            Content = "Komentarz 4",
                            Date = new DateTime(2024, 7, 23, 15, 10, 18, 805, DateTimeKind.Local).AddTicks(8801),
                            IdPost = 1,
                            IdUser = 1
                        });
                });
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2024, 7, 23, 15, 10, 18, 805, DateTimeKind.Local).AddTicks(8688),
                            IdGame = 1,
                            IdUser = 1,
                        ...
                        new
                        {
                            ...
                            Date = new DateTime(2024, 7, 23, 15, 10, 18, 805, DateTimeKind.Local).AddTicks(8702),
                            IdGame = 1,
                            IdUser = 1,
                            Title = "CUNTER STRIKE"
                        },
                        new
                        {
                            PostId = 3,
                            Content = "jak w temacie",
                            Date = new DateTime(2024, 7, 23, 15, 10, 18, 805, DateTimeKind.Local).AddTicks(8704),
                            IdGame = 1,
                            IdUser = 1,
                        ...
                        new
                        {
                            PostId = 4,
                            Content = "long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versi",
                            Date = new DateTime(2024, 7, 23, 15, 10, 18, 805, DateTimeKind.Local).AddTicks(8706),
                            IdGame = 1,
                            IdUser = 1,
                            Title = "REPORT GARO"
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2024, 7, 23, 15, 10, 18, 805, DateTimeKind.Local).AddTicks(8707),
                            IdGame = 1,
                            IdUser = 1,
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            BirthDate = new DateTime(2004, 7, 23, 15, 10, 18, 805, DateTimeKind.Local).AddTicks(5508),
                        ...
                        {
                            UserId = 2,
                            BirthDate = new DateTime(1999, 7, 23, 15, 10, 18, 805, DateTimeKind.Local).AddTicks(5552),
                            Description = "Lubie CS GO",
                        ...
                        {
                            UserId = 3,
                            BirthDate = new DateTime(1994, 7, 23, 15, 10, 18, 805, DateTimeKind.Local).AddTicks(5557),
                            Description = "Lubie CS GO",
                            Email = "Zielony@o2.pl",
                            IconPath = "../../images/users/default.png",
                            Login = "Garo",
