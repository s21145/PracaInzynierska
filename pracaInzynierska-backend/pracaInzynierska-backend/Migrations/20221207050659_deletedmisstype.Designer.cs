...
namespace pracaInzynierska_backend.Migrations
{
    ...
    [Migration("20221207050659_deletedmisstype")]
    partial class deletedmisstype
    {
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CommentId = 1,
                            Content = "Komentarz 1",
                            Date = new DateTime(2022, 12, 7, 6, 6, 58, 741, DateTimeKind.Local).AddTicks(1925),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 2,
                            Content = "Komentarz 2",
                            Date = new DateTime(2022, 12, 7, 6, 6, 58, 741, DateTimeKind.Local).AddTicks(1937),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 3,
                            Content = "Komentarz 3",
                            Date = new DateTime(2022, 12, 7, 6, 6, 58, 741, DateTimeKind.Local).AddTicks(1939),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 4,
                            Content = "Komentarz 4",
                            Date = new DateTime(2022, 12, 7, 6, 6, 58, 741, DateTimeKind.Local).AddTicks(1940),
                            IdPost = 1,
                            IdUser = 1
                        });
                });
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            BirthDate = new DateTime(2002, 12, 7, 6, 6, 58, 740, DateTimeKind.Local).AddTicks(7821),
                        ...
                        {
                            UserId = 2,
                            BirthDate = new DateTime(1997, 12, 7, 6, 6, 58, 740, DateTimeKind.Local).AddTicks(7849),
                            Description = "Lubie CS GO",
                        ...
                        {
                            UserId = 3,
                            BirthDate = new DateTime(1992, 12, 7, 6, 6, 58, 740, DateTimeKind.Local).AddTicks(7852),
                            Description = "Lubie CS GO",
                            Email = "Zielony@o2.pl",
                            IconPath = "../../images/default.png",
                            Login = "Garo",
