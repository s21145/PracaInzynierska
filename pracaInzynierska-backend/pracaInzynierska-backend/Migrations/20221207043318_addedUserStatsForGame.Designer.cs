...
namespace pracaInzynierska_backend.Migrations
{
    ...
    [Migration("20221207043318_addedUserStatsForGame")]
    partial class addedUserStatsForGame
    {
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CommentId = 1,
                            Content = "Komentarz 1",
                            Date = new DateTime(2022, 12, 7, 5, 33, 18, 270, DateTimeKind.Local).AddTicks(7170),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 2,
                            Content = "Komentarz 2",
                            Date = new DateTime(2022, 12, 7, 5, 33, 18, 270, DateTimeKind.Local).AddTicks(7180),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 3,
                            Content = "Komentarz 3",
                            Date = new DateTime(2022, 12, 7, 5, 33, 18, 270, DateTimeKind.Local).AddTicks(7182),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 4,
                            Content = "Komentarz 4",
                            Date = new DateTime(2022, 12, 7, 5, 33, 18, 270, DateTimeKind.Local).AddTicks(7183),
                            IdPost = 1,
                            IdUser = 1
                        });
                });
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            BirthDate = new DateTime(2002, 12, 7, 5, 33, 18, 270, DateTimeKind.Local).AddTicks(3531),
                        ...
                        {
                            UserId = 2,
                            BirthDate = new DateTime(1997, 12, 7, 5, 33, 18, 270, DateTimeKind.Local).AddTicks(3559),
                            Description = "Lubie CS GO",
                        ...
                        {
                            UserId = 3,
                            BirthDate = new DateTime(1992, 12, 7, 5, 33, 18, 270, DateTimeKind.Local).AddTicks(3562),
                            Description = "Lubie CS GO",
                            Email = "Zielony@o2.pl",
                            IconPath = "../../images/default.png",
                            Login = "Garo",
