...
namespace pracaInzynierska_backend.Migrations
{
    ...
    [Migration("20221210174411_requiredImagePath")]
    partial class requiredImagePath
    {
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CommentId = 1,
                            Content = "Komentarz 1",
                            Date = new DateTime(2022, 12, 10, 18, 44, 11, 349, DateTimeKind.Local).AddTicks(9746),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 2,
                            Content = "Komentarz 2",
                            Date = new DateTime(2022, 12, 10, 18, 44, 11, 349, DateTimeKind.Local).AddTicks(9757),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 3,
                            Content = "Komentarz 3",
                            Date = new DateTime(2022, 12, 10, 18, 44, 11, 349, DateTimeKind.Local).AddTicks(9759),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 4,
                            Content = "Komentarz 4",
                            Date = new DateTime(2022, 12, 10, 18, 44, 11, 349, DateTimeKind.Local).AddTicks(9760),
                            IdPost = 1,
                            IdUser = 1
                        });
                });
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            BirthDate = new DateTime(2002, 12, 10, 18, 44, 11, 349, DateTimeKind.Local).AddTicks(6192),
                        ...
                        {
                            UserId = 2,
                            BirthDate = new DateTime(1997, 12, 10, 18, 44, 11, 349, DateTimeKind.Local).AddTicks(6219),
                            Description = "Lubie CS GO",
                        ...
                        {
                            UserId = 3,
                            BirthDate = new DateTime(1992, 12, 10, 18, 44, 11, 349, DateTimeKind.Local).AddTicks(6221),
                            Description = "Lubie CS GO",
                            Email = "Zielony@o2.pl",
                            IconPath = "../../images/users/default.png",
                            Login = "Garo",
