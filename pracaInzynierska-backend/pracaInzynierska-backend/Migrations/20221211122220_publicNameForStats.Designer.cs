...
namespace pracaInzynierska_backend.Migrations
{
    ...
    [Migration("20221211122220_publicNameForStats")]
    partial class publicNameForStats
    {
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CommentId = 1,
                            Content = "Komentarz 1",
                            Date = new DateTime(2022, 12, 11, 13, 22, 19, 888, DateTimeKind.Local).AddTicks(92),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 2,
                            Content = "Komentarz 2",
                            Date = new DateTime(2022, 12, 11, 13, 22, 19, 888, DateTimeKind.Local).AddTicks(105),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 3,
                            Content = "Komentarz 3",
                            Date = new DateTime(2022, 12, 11, 13, 22, 19, 888, DateTimeKind.Local).AddTicks(106),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 4,
                            Content = "Komentarz 4",
                            Date = new DateTime(2022, 12, 11, 13, 22, 19, 888, DateTimeKind.Local).AddTicks(108),
                            IdPost = 1,
                            IdUser = 1
                        });
                });
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            BirthDate = new DateTime(2002, 12, 11, 13, 22, 19, 887, DateTimeKind.Local).AddTicks(6266),
                        ...
                        {
                            UserId = 2,
                            BirthDate = new DateTime(1997, 12, 11, 13, 22, 19, 887, DateTimeKind.Local).AddTicks(6296),
                            Description = "Lubie CS GO",
                        ...
                        {
                            UserId = 3,
                            BirthDate = new DateTime(1992, 12, 11, 13, 22, 19, 887, DateTimeKind.Local).AddTicks(6298),
                            Description = "Lubie CS GO",
                            Email = "Zielony@o2.pl",
                            IconPath = "../../images/users/default.png",
                            Login = "Garo",
