...
namespace pracaInzynierska_backend.Migrations
{
    ...
    [Migration("20221113203825_steamId")]
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CommentId = 1,
                            Content = "Komentarz 1",
                            Date = new DateTime(2022, 11, 13, 21, 38, 25, 529, DateTimeKind.Local).AddTicks(3761),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 2,
                            Content = "Komentarz 2",
                            Date = new DateTime(2022, 11, 13, 21, 38, 25, 529, DateTimeKind.Local).AddTicks(3771),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 3,
                            Content = "Komentarz 3",
                            Date = new DateTime(2022, 11, 13, 21, 38, 25, 529, DateTimeKind.Local).AddTicks(3772),
                            IdPost = 1,
                            IdUser = 1
                        },
                        new
                        {
                            CommentId = 4,
                            Content = "Komentarz 4",
                            Date = new DateTime(2022, 11, 13, 21, 38, 25, 529, DateTimeKind.Local).AddTicks(3774),
                            IdPost = 1,
                            IdUser = 1
                        });
                });
            ...
            modelBuilder.Entity("pracaInzynierska_backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            BirthDate = new DateTime(2002, 11, 13, 21, 38, 25, 529, DateTimeKind.Local).AddTicks(290),
                        ...
                        {
                            UserId = 2,
                            BirthDate = new DateTime(1997, 11, 13, 21, 38, 25, 529, DateTimeKind.Local).AddTicks(324),
                            Description = "Lubie CS GO",
                        ...
                        {
                            UserId = 3,
                            BirthDate = new DateTime(1992, 11, 13, 21, 38, 25, 529, DateTimeKind.Local).AddTicks(327),
                            Description = "Lubie CS GO",
                            Email = "Zielony@o2.pl",
                            IconPath = "../../images/default.png",
                            Login = "Garo",
