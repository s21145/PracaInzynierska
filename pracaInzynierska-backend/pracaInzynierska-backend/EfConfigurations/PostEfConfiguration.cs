...
namespace pracaInzynierska_backend.EfConfigurations
{
    public class PostEfConfiguration : IEntityTypeConfiguration<Post>
    {
        ...
        private void SeedData(EntityTypeBuilder<Post> builder)
        {
            builder
                .HasData(
                new Post { PostId =1,Title="Ale CunterStrike jest kozak", Content = "jak w temacie",IdUser=1,IdGame=1},
                new Post { PostId = 2, Title = "CUNTER STRIKE",
                    ...
                    IdUser = 1, IdGame = 1 },
                new Post { PostId = 3, Title = "CZY CUNTERSTRIKE JEST LEPSZE OD ESCAPE FROM TARKOV", Content = "jak w temacie", IdUser = 1, IdGame = 1 },
