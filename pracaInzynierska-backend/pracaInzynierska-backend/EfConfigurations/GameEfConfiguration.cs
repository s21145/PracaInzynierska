...
namespace pracaInzynierska_backend.EfConfigurations
{
    public class GameEfConfiguration : IEntityTypeConfiguration<Game>
    {
        ...
        {
            builder.HasData(
                new Game { GameId =1,Name="CounterStrike",Publisher="Valve",ImagePath= "../../images/games/csgo.jpg" },
                ...
                new Game { GameId = 4, Name = "Rust", Publisher = "ktos?", ImagePath = "../../images/games/rust.jpg" }
                );
        }
    }
}
